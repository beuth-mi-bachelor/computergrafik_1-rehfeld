...
/**
 * This class is a loader for the OBJ File format
 */
        ...
        public Node OBJLoader() {
                    try {
                        ...
                        for (int i = 0; i < vertexFaces.size(); i++) {
                            ...
                            triangles.add(new Triangle(a, b, c, normal, normal, normal, material));
                    ...
                    return new Node(new Transform(), triangles, this.material);
                }
