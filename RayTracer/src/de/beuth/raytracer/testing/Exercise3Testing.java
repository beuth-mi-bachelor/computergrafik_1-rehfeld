...
public class Exercise3Testing {
    ...
    public static final Triangle triangle = new Triangle(new Point3(0, 0, -1), new Point3(1, 0, -1), new Point3(1, 1, -1), single_material_triangle);
    ...
    public static final Triangle triangle2 = new Triangle(new Point3(0, 0, -1), new Point3(1, 0, -1), new Point3(1, 1, -1), lambert_material_triangle);
    ...
    public static final Triangle triangle3 = new Triangle(new Point3(0, 0, -1), new Point3(1, 0, -1), new Point3(1, 1, -1), Phong_material_triangle);
    ...
    public static final Triangle triangle4 = new Triangle(new Point3(0, 0, -1), new Point3(1, 0, -1), new Point3(1, 1, -1), BlinnPhong_material_triangle);
    ...
    public static void runExample3() {
        ...
        PointLight light = new PointLight(new Color(1,1,1), new Point3(4,4,4));
        ArrayList<Light> lights = new ArrayList<Light>();
        lights.add(light);
        World world = new World(geoList,lights, Exercise3Testing.ambientLight);
    ...
    public static void runExample4() {
        ...
        ArrayList<Light> lights = new ArrayList<Light>();
        lights.add(light);
        World world = new World(geoList,lights, Exercise3Testing.ambientLightNormal);
        new RayTracer(world, Exercise3Testing.camera);
    }
    ...
    public static void runExample6() {
        ...
        geoList.add(Exercise3Testing.box3);
        geoList.add(Exercise3Testing.triangle3);
        DirectionalLight light = new DirectionalLight(new Color(1,1,1), new Vector3(-1, -1, -1));
        ArrayList<Light> lights = new ArrayList<Light>();
        lights.add(light);
        World world = new World(geoList,lights, Exercise3Testing.ambientLightNormal);
        new RayTracer(world, Exercise3Testing.camera);
    ...
    public static void runExample7() {
        ...
        geoList.add(Exercise3Testing.box3);
        geoList.add(Exercise3Testing.triangle3);
        SpotLight light = new SpotLight(new Color(1,1,1), new Point3(4, 4, 4), new Vector3(-1, -1, -1), Math.PI/14);
        ArrayList<Light> lights = new ArrayList<Light>();
        lights.add(light);
        World world = new World(geoList,lights, Exercise3Testing.ambientLightNormal);
        new RayTracer(world, Exercise3Testing.camera);
    ...
    public static void runExample8() {
        ...
        geoList.add(Exercise3Testing.box3);
        geoList.add(Exercise3Testing.triangle3);
        SpotLight light = new SpotLight(new Color(1,1,1), new Point3(5,5,5), new Vector3(-1, -1, -1), Math.PI/14);
        ArrayList<Light> lights = new ArrayList<Light>();
        lights.add(light);
        World world = new World(geoList,lights, Exercise3Testing.ambientLight);
        new RayTracer(world, Exercise3Testing.camera);
    ...
    public static void ownExample() {
        ...
        PointLight light = new PointLight(new Color(1,1,1), new Point3(4,4,4));
        SpotLight light1 = new SpotLight(new Color(1,1,1), new Point3(5, 5, 5), new Vector3(-0.5, -0.5, -0.5), Math.PI/9);
        ArrayList<Light> lights = new ArrayList<Light>();
        lights.add(light);
        lights.add(light1);
        World world = new World(geoList,lights, Exercise3Testing.ambientLightNormal);
