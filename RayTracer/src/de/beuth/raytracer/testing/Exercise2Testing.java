...
public class Exercise2Testing {
    ...
    // exercise 1
    public static final Material ex1_mat = new SingleColorMaterial(new SingleColorTexture(new Color(0, 1, 0)));
    ...
    // exercise 2
    public static final Material ex2_mat = new SingleColorMaterial(new SingleColorTexture(new Color(1, 0, 0)));
    ...
    //exercise 3
    public static final Material ex3_mat = new SingleColorMaterial(new SingleColorTexture(new Color(0, 0, 1)));
    ...
    //exercise 4
    public static final Material ex4_mat = new SingleColorMaterial(new SingleColorTexture(new Color(1, 0, 1)));
    ...
    // exercise 5
    public static final Material ex5_mat = new SingleColorMaterial(new SingleColorTexture(new Color(1, 0, 0)));
    ...
    // exercise 6
    public static final Material ex6_mat = new SingleColorMaterial(new SingleColorTexture(new Color(1, 0, 0)));
